...
def get_args_parser():
    ...
    parser.add_argument('--use-mcloader', action='store_true', default=True, help='Use mcloader')
    ...
    parser.add_argument('--port', default=-1, type=int, help='distributed port')
